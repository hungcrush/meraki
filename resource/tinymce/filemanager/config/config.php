...
$baseURL .= isset($_SERVER['SCRIPT_NAME']) ? str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']) : '';

$baseURL = str_replace('/resource/tinymce/filemanager', '', $baseURL);
