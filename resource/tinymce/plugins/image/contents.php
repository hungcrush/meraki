...
if(count($current_folder_content) > 0 AND CanAcessLibrary()){
	...
	foreach($current_folder_content as $c){
		if($view == 'list'){
			...
			<div class="name_file pull-left"><small class="muted">'. $c['name'] .'</small></div>
			<a href="" class="pull-right transparent change-folder" title="Change Name" rel="'. $c['name'] .'"><i class="icon-pencil"></i></a>
			<a href="" style="margin-right: 10px;" class="pull-right transparent delete-folder" rel="'. urlencode($c['path']).'" title="Delete"><i class="icon-trash"></i></a>
			<div>
			...
			<div class="name_file pull-left"><small class="muted">'. $c['name'] .'</small></div>
			<a href="" class="pull-right transparent change-file" title="Change Name" rel="'. $c['name'] .'"><i class="icon-pencil"></i></a>
			<a href="" style="margin-right: 10px;" class="pull-right transparent delete-file" rel="'. urlencode($c['p']).'" title="Delete"><i class="icon-trash"></i></a>
			<div>
